...
int main() {
    ...
    runApp(base, roundedMax, "Trajectory of Standard Vehicle using Kinematic Bycicle Model");
    ...
    runApp(baseDrift, roundedMax, "Trajectory of Standard Vehicle with Lateral Drift");
    ...
    runApp(headingStraight, roundedMax, "Trajectory of Vehicle Controlled to Have a Straight Heading");
    ...
    runApp(headingStraightDrift, roundedMax, "Trajectory of Vehicle Controlled to Have a Straight Heading, with Noise and Lateral Drift");
    ...
    runApp(pStraight, straightPath, max (pathRoundedMax, roundedMax), "Straight Trajectory of Vehicle: P Controller");
    ...
    runApp(pidStraight, straightPath, max (pathRoundedMax, roundedMax), "Straight Trajectory of Vehicle: PID Controller");
    ...
    runApp(stanleyStraight, straightPath, max (pathRoundedMax, roundedMax), "Straight Trajectory of Vehicle: Stanley Controller");
    ...
    runApp(pCircular, circularPath, max(roundedMax, pathRoundedMax), "Circular Trajectory of Vehicle: P Controller");
    ...
    runApp(pidCircular, circularPath, max(roundedMax, pathRoundedMax), "Circular Trajectory of Vehicle: PID Controller");
    ...
    runApp(stanleyCircular, circularPath, max(roundedMax, pathRoundedMax), "Circular Trajectory of Vehicle: Stanley Controller");
    ...
    runApp(pSine ,sinePath, max(roundedMax, pathRoundedMax), "Sine Trajectory of Vehicle: P Controller");
    ...
    runApp(pidSine ,sinePath, max(roundedMax, pathRoundedMax), "Sine Trajectory of Vehicle: PID Controller");
    ...
    runApp(stanleySine ,sinePath, max(roundedMax, pathRoundedMax), "Sine Trajectory of Vehicle: Stanley Controller");
    ...
    runApp(pidChicane ,chicanePath, max(roundedMax, pathRoundedMax), "Chicane Trajectory of Vehicle: PID Controller");
    ...
    runApp(stanleyChicane ,chicanePath, max(roundedMax, pathRoundedMax), "Chicane Trajectory of Vehicle: Stanley Controller");
